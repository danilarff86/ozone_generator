...
const char* main_menu_str = "MAIN MENU";
...
const uint8_t menu_items_on_screen = 6;
int8_t menu_mode = -1;
int16_t menu_line = -1;
uint8_t menu_start = 0;
bool menu_item_changed = false;
const int16_t slider_height = 80;
unsigned long ms_interval = 1000;
...
handle_main_menu( )
{
    ...
    if ( menu_line == prev_menu_line && !check_menu_item_changed( ) )
    {
        return;
    }
